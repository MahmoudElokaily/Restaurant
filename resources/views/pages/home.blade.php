...
@section('content')
        ...
        <div class="swiper-wrapper text-sm-left">
            ...
            @foreach($swiperImages as $swiperImage )
                @if($i == 3)
                    @break
                @endif
                <div class="swiper-slide context-dark" data-slide-bg="{{asset('brands/' . $swiperImage->image)}}">
                <div class="swiper-slide-caption section-md">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-9 col-md-8 col-lg-7 col-xl-7 offset-lg-1 offset-xxl-0">
                                <h1 class="oh swiper-title"><span class="d-inline-block" data-caption-animate="slideInUp" data-caption-delay="0">{{$swiperImage->name}}</span></h1>
                                <p class="big swiper-text" data-caption-animate="fadeInLeft" data-caption-delay="300">{{$swiperImage->description}}</p><a class="button button-lg button-primary button-winona button-shadow-2" href="#" data-caption-animate="fadeInUp" data-caption-delay="300">View our menu</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="oh-desktop">
                            ...
                            <article class="services-terri wow slideInUp">
                                <div class="services-terri-figure"><img src="{{asset('brands/'.$swiperImage->image)}}" alt="" width="370" height="278"/>
                                </div>
                                <div class="services-terri-caption"><span class="services-terri-icon linearicons-leaf"></span>
                                    <h5 class="services-terri-title"><a href="#">{{$swiperImage->name}}</a></h5>
                                </div>
                            </article>
                        </div>
                    </div>
    ...
    <!-- Section CTA-->
    <section class="primary-overlay section parallax-container" data-parallax-img="{{asset('')}}images/bg-3.jpg">
            ...
            <div class="row row-lg row-30">
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    ...
                    <article class="product wow fadeInLeft" data-wow-delay=".15s">
                        <div class="product-figure"><img src="{{asset('')}}images/product-1-161x162.png" alt="" width="161" height="162"/>
                        </div>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    ...
                    <article class="product wow fadeInLeft" data-wow-delay=".1s">
                        <div class="product-figure"><img src="{{asset('')}}images/product-2-161x162.png" alt="" width="161" height="162"/>
                        </div>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    ...
                    <article class="product wow fadeInLeft" data-wow-delay=".05s">
                        <div class="product-figure"><img src="{{asset('')}}images/product-3-161x162.png" alt="" width="161" height="162"/>
                        </div>
                        <div class="product-rating"><span class="mdi mdi-star"></span><span class="mdi mdi-star"></span><span class="mdi mdi-star"></span><span class="mdi mdi-star"></span><span class="mdi mdi-star text-gray-13"></span>
                        </div>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    ...
                    <article class="product wow fadeInLeft">
                        <div class="product-figure"><img src="{{asset('')}}images/product-4-161x162.png" alt="" width="161" height="162"/>
                        </div>
                        <div class="product-rating"><span class="mdi mdi-star"></span><span class="mdi mdi-star"></span><span class="mdi mdi-star"></span><span class="mdi mdi-star"></span><span class="mdi mdi-star"></span>
                        </div>
            ...
            <div class="owl-carousel owl-style-12" data-items="1" data-sm-items="2" data-lg-items="3" data-margin="30" data-xl-margin="45" data-autoplay="true" data-nav="true" data-center="true" data-smart-speed="400">
                ...
                <article class="quote-tara">
                    <div class="quote-tara-caption">
                        ...
                        <div class="quote-tara-figure"><img src="{{asset('')}}images/user-6-115x115.jpg" alt="" width="115" height="115"/>
                        </div>
                    </div>
                ...
                <article class="quote-tara">
                    <div class="quote-tara-caption">
                        ...
                        <div class="quote-tara-figure"><img src="{{asset('')}}images/user-8-115x115.jpg" alt="" width="115" height="115"/>
                        </div>
                    </div>
                ...
                <article class="quote-tara">
                    <div class="quote-tara-caption">
                        ...
                        <div class="quote-tara-figure"><img src="{{asset('')}}images/user-7-115x115.jpg" alt="" width="115" height="115"/>
                        </div>
                    </div>
                ...
                <article class="quote-tara">
                    <div class="quote-tara-caption">
                        ...
                        <div class="quote-tara-figure"><img src="{{asset('')}}images/user-9-115x115.jpg" alt="" width="115" height="115"/>
                        </div>
                    </div>
        ...
        <div class="container-fluid container-inset-0 isotope-wrap">
            <div class="row row-10 gutters-10 isotope" data-isotope-layout="masonry" data-isotope-group="gallery" data-lightgallery="group">
                <div class="col-xs-6 col-sm-4 col-xl-2 isotope-item oh-desktop">
                    <!-- Thumbnail Mary-->
                    <article class="thumbnail thumbnail-mary thumbnail-mary-2 wow slideInLeft"><a class="thumbnail-mary-figure" href="{{asset('')}}images/gallery-1-1200x800-original.jpg" data-lightgallery="item"><img src="{{asset('')}}images/gallery-1-310x585.jpg" alt="" width="310" height="585"/></a>
                ...
                <div class="col-xs-6 col-sm-8 col-xl-4 isotope-item oh-desktop">
                    <!-- Thumbnail Mary-->
                    <article class="thumbnail thumbnail-mary thumbnail-mary-big wow slideInRight"><a class="thumbnail-mary-figure" href="{{asset('')}}images/gallery-2-1200x800-original.jpg" data-lightgallery="item"><img src="{{asset('')}}images/gallery-2-631x587.jpg" alt="" width="631" height="587"/></a>
                        <div class="thumbnail-mary-caption">
                            <div>
                ...
                <div class="col-xs-6 col-sm-4 col-xl-2 isotope-item oh-desktop">
                    <!-- Thumbnail Mary-->
                    <article class="thumbnail thumbnail-mary thumbnail-mary-2 wow slideInDown"><a class="thumbnail-mary-figure" href="{{asset('')}}images/gallery-3-1200x800-original.jpg" data-lightgallery="item"><img src="{{asset('')}}images/gallery-3-311x289.jpg" alt="" width="311" height="289"/></a>
                        <div class="thumbnail-mary-caption">
                            <div>
                ...
                <div class="col-xs-6 col-sm-8 col-xl-4 isotope-item oh-desktop">
                    <!-- Thumbnail Mary-->
                    <article class="thumbnail thumbnail-mary wow slideInUp"><a class="thumbnail-mary-figure" href="{{asset('')}}images/gallery-4-1200x800-original.jpg" data-lightgallery="item"><img src="{{asset('')}}images/gallery-4-631x289.jpg" alt="" width="631" height="289"/></a>
                        <div class="thumbnail-mary-caption">
                            <div>
                ...
                <div class="col-xs-6 col-sm-4 col-xl-2 isotope-item oh-desktop">
                    <!-- Thumbnail Mary-->
                    <article class="thumbnail thumbnail-mary thumbnail-mary-2 wow slideInUp"><a class="thumbnail-mary-figure" href="{{asset('')}}images/gallery-5-1200x800-original.jpg" data-lightgallery="item"><img src="{{asset('')}}images/gallery-5-311x289.jpg" alt="" width="311" height="289"/></a>
                        <div class="thumbnail-mary-caption">
                            <div>
                ...
                <div class="col-xs-6 col-sm-4 col-xl-2 isotope-item oh-desktop">
                    <!-- Thumbnail Mary-->
                    <article class="thumbnail thumbnail-mary thumbnail-mary-2 wow slideInRight"><a class="thumbnail-mary-figure" href="{{asset('')}}images/gallery-6-1200x800-original.jpg" data-lightgallery="item"><img src="{{asset('')}}images/gallery-6-311x289.jpg" alt="" width="311" height="289"/></a>
                        <div class="thumbnail-mary-caption">
                            <div>
                ...
                <div class="col-xs-6 col-sm-4 col-xl-2 isotope-item oh-desktop">
                    <!-- Thumbnail Mary-->
                    <article class="thumbnail thumbnail-mary thumbnail-mary-2 wow slideInLeft"><a class="thumbnail-mary-figure" href="{{asset('')}}images/gallery-7-1200x800-original.jpg" data-lightgallery="item"><img src="{{asset('')}}images/gallery-7-311x289.jpg" alt="" width="311" height="289"/></a>
                        <div class="thumbnail-mary-caption">
                            <div>
